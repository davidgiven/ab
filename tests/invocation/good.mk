...
tests/invocation/+r1 $(OBJ)/.sentinels/tests/invocation/+r1.mark $(OBJ)/tests/invocation/+r1/r1.txt &:
...
tests/invocation/+r2 $(OBJ)/.sentinels/tests/invocation/+r2.mark $(OBJ)/tests/invocation/+r2/r2.txt &:
...
.PHONY: +fortesting
+fortesting $(OBJ)/.sentinels/+fortesting.mark $(OBJ)/+fortesting/out &:
...
tests/invocation/+all $(OBJ)/.sentinels/tests/invocation/+all.mark &: $(OBJ)/tests/invocation/+r1/r1.txt $(OBJ)/tests/invocation/+r2/r2.txt $(OBJ)/+fortesting/out
	$(hide) mkdir -p $(OBJ)/.sentinels/tests/invocation
	$(hide) touch $@

.PHONY: tests/invocation/+r3
tests/invocation/+r3 $(OBJ)/.sentinels/tests/invocation/+r3.mark $(OBJ)/tests/invocation/+r3/r3.txt &:
...
tests/invocation/+r4 $(OBJ)/.sentinels/tests/invocation/+r4.mark $(OBJ)/tests/invocation/+r4/r4.txt &:
