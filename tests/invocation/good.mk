...
$(OBJ)/.sentinels/tests/invocation/+r1.mark $(OBJ)/tests/invocation/+r1/r1.txt :
...
$(OBJ)/.sentinels/tests/invocation/+r2.mark $(OBJ)/tests/invocation/+r2/r2.txt :
...
$(OBJ)/.sentinels/+fortesting.mark $(OBJ)/+fortesting/out :
...
$(OBJ)/.sentinels/tests/invocation/+r3.mark $(OBJ)/tests/invocation/+r3/r3.txt :
...
$(OBJ)/.sentinels/tests/invocation/+r4.mark $(OBJ)/tests/invocation/+r4/r4.txt :
