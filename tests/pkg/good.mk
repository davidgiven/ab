...
tests/pkg+cprogram/tests/pkg/cfile.c $(OBJ)/tests/pkg+cprogram/tests/pkg/cfile.c/cfile.o &: tests/pkg/cfile.c tests/pkg+missingpkg tests/pkg+foundpkg
...
tests/pkg+cprogram $(OBJ)/tests/pkg+cprogram/pkg+cprogram &: tests/pkg+cprogram/tests/pkg/cfile.c tests/pkg+missingpkg tests/pkg+foundpkg
