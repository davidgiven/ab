...
tests/cprogram/+cfile $(OBJ)/.sentinels/tests/cprogram/+cfile.mark $(OBJ)/tests/cprogram/+cfile/cfile.o &: tests/cprogram/cfile.c
...
tests/cprogram/+cxxfile $(OBJ)/.sentinels/tests/cprogram/+cxxfile.mark $(OBJ)/tests/cprogram/+cxxfile/cxxfile.o &: tests/cprogram/cxxfile.c
...
tests/cprogram/+cprogram/tests/cprogram/implicitcfile.c $(OBJ)/.sentinels/tests/cprogram/+cprogram/tests/cprogram/implicitcfile.c.mark $(OBJ)/tests/cprogram/+cprogram/tests/cprogram/implicitcfile.c/implicitcfile.o &: tests/cprogram/implicitcfile.c
...
tests/cprogram/+cprogram $(OBJ)/.sentinels/tests/cprogram/+cprogram.mark $(OBJ)/tests/cprogram/+cprogram/+cprogram$(EXT) &: $(OBJ)/tests/cprogram/+cprogram/tests/cprogram/implicitcfile.c/implicitcfile.o $(OBJ)/tests/cprogram/+cfile/cfile.o
...
tests/cprogram/+cxxprogram/tests/cprogram/implicitcxxfile.cc $(OBJ)/.sentinels/tests/cprogram/+cxxprogram/tests/cprogram/implicitcxxfile.cc.mark $(OBJ)/tests/cprogram/+cxxprogram/tests/cprogram/implicitcxxfile.cc/implicitcxxfile.o &: tests/cprogram/implicitcxxfile.cc
...
tests/cprogram/+cxxprogram $(OBJ)/.sentinels/tests/cprogram/+cxxprogram.mark $(OBJ)/tests/cprogram/+cxxprogram/+cxxprogram$(EXT) &: $(OBJ)/tests/cprogram/+cxxprogram/tests/cprogram/implicitcxxfile.cc/implicitcxxfile.o $(OBJ)/tests/cprogram/+cxxfile/cxxfile.o
...
tests/cprogram/+all $(OBJ)/.sentinels/tests/cprogram/+all.mark &: $(OBJ)/tests/cprogram/+cfile/cfile.o $(OBJ)/tests/cprogram/+cxxfile/cxxfile.o $(OBJ)/tests/cprogram/+cprogram/+cprogram$(EXT) $(OBJ)/tests/cprogram/+cxxprogram/+cxxprogram$(EXT)
	$(hide) mkdir -p $(OBJ)/.sentinels/tests/cprogram
	$(hide) touch $@
AB_LOADED = 1
