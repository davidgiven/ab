...
tests/cprogram/+cprogram : $(OBJ)/tests/cprogram/+cprogram/+cprogram$(EXT) ;
$(OBJ)/tests/cprogram/+cprogram/+cprogram$(EXT) &: $(OBJ)/tests/cprogram/+cprogram/tests/cprogram/implicitcfile.c/implicitcfile.o $(OBJ)/tests/cprogram/+cfile/cfile.o
...
tests/cprogram/+cxxprogram : $(OBJ)/tests/cprogram/+cxxprogram/+cxxprogram$(EXT) ;
$(OBJ)/tests/cprogram/+cxxprogram/+cxxprogram$(EXT) &: $(OBJ)/tests/cprogram/+cxxprogram/tests/cprogram/implicitcxxfile.cc/implicitcxxfile.o $(OBJ)/tests/cprogram/+cxxfile/cxxfile.o
...
tests/cprogram/+all &: $(OBJ)/tests/cprogram/+cfile/cfile.o $(OBJ)/tests/cprogram/+cxxfile/cxxfile.o $(OBJ)/tests/cprogram/+cprogram/+cprogram$(EXT) $(OBJ)/tests/cprogram/+cxxprogram/+cxxprogram$(EXT)
	@
AB_LOADED = 1
