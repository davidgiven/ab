...
tests/cprogram+cfile $(OBJ)/tests/cprogram+cfile/cfile.o &: tests/cprogram/cfile.c
...
tests/cprogram+cxxfile $(OBJ)/tests/cprogram+cxxfile/cxxfile.o &: tests/cprogram/cxxfile.c
...
tests/cprogram+cprogram/tests/cprogram/implicitcfile.c $(OBJ)/tests/cprogram+cprogram/tests/cprogram/implicitcfile.c/implicitcfile.o &: tests/cprogram/implicitcfile.c
...
tests/cprogram+cprogram $(OBJ)/tests/cprogram+cprogram/cprogram+cprogram &: tests/cprogram+cprogram/tests/cprogram/implicitcfile.c tests/cprogram+cfile
...
tests/cprogram+cxxprogram/tests/cprogram/implicitcxxfile.cc $(OBJ)/tests/cprogram+cxxprogram/tests/cprogram/implicitcxxfile.cc/implicitcxxfile.o &: tests/cprogram/implicitcxxfile.cc
...
tests/cprogram+cxxprogram $(OBJ)/tests/cprogram+cxxprogram/cprogram+cxxprogram &: tests/cprogram+cxxprogram/tests/cprogram/implicitcxxfile.cc tests/cprogram+cxxfile
