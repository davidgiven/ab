...
$(OBJ)/tests/clibrary+clibrary/clibrary+clibrary.a $(OBJ)/tests/clibrary+clibrary/library.h &: tests/clibrary+clibrary/tests/clibrary/lib1.c tests/clibrary+clibrary/tests/clibrary/lib2.cc
...
$(OBJ)/tests/clibrary+cfile/prog.o &: tests/clibrary/prog.c tests/clibrary+clibrary
...
$(OBJ)/tests/clibrary+cprogram/clibrary+cprogram &: tests/clibrary+cfile $(OBJ)/tests/clibrary+clibrary/clibrary+clibrary.a tests/clibrary+clibrary
