...
$(OBJ)/tests/clibrary+clibrary/clibrary+clibrary.a $(OBJ)/tests/clibrary+clibrary/library.h &: $(OBJ)/tests/clibrary+clibrary/tests/clibrary/lib1.c/lib1.o $(OBJ)/tests/clibrary+clibrary/tests/clibrary/lib2.cc/lib2.o
...
$(OBJ)/tests/clibrary+cprogram/clibrary+cprogram &: $(OBJ)/tests/clibrary+cfile/prog.o $(OBJ)/tests/clibrary+clibrary/clibrary+clibrary.a $(OBJ)/tests/clibrary+clibrary/library.h
