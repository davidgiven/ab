...
$(OBJ)/tests/clibrary/+cfile/prog.o &: tests/clibrary/prog.c $(OBJ)/tests/clibrary/+clibrary/+clibrary.a
...
tests/clibrary/+all &: $(OBJ)/tests/clibrary/+cprogram/+cprogram$(EXT)
	@
AB_LOADED = 1
