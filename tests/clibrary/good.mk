...
$(OBJ)/.sentinels/tests/clibrary/+cheaders.mark $(OBJ)/tests/clibrary/+cheaders/library.h : tests/clibrary/library.h
...
$(OBJ)/.sentinels/tests/clibrary/+cfile.mark $(OBJ)/tests/clibrary/+cfile/prog.o : tests/clibrary/prog.c $(OBJ)/tests/clibrary/+cheaders/library.h
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary/tests/clibrary/lib1.c.mark $(OBJ)/tests/clibrary/+clibrary/tests/clibrary/lib1.c/lib1.o : tests/clibrary/lib1.c $(OBJ)/tests/clibrary/+cheaders/library.h
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary/tests/clibrary/lib2.cc.mark $(OBJ)/tests/clibrary/+clibrary/tests/clibrary/lib2.cc/lib2.o : tests/clibrary/lib2.cc $(OBJ)/tests/clibrary/+cheaders/library.h
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary.mark $(OBJ)/tests/clibrary/+clibrary/+clibrary.a : $(OBJ)/tests/clibrary/+clibrary/tests/clibrary/lib1.c/lib1.o $(OBJ)/tests/clibrary/+clibrary/tests/clibrary/lib2.cc/lib2.o
...
$(OBJ)/.sentinels/tests/clibrary/+cprogram.mark $(OBJ)/tests/clibrary/+cprogram/+cprogram$(EXT) : $(OBJ)/tests/clibrary/+cfile/prog.o $(OBJ)/tests/clibrary/+clibrary/+clibrary.a $(OBJ)/tests/clibrary/+clibrary/+clibrary.a $(OBJ)/tests/clibrary/+clibrary/+clibrary.a
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary2_hdrs.mark $(OBJ)/tests/clibrary/+clibrary2_hdrs/library2.h : tests/clibrary/library2.h
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary2/tests/clibrary/lib1.c.mark $(OBJ)/tests/clibrary/+clibrary2/tests/clibrary/lib1.c/lib1.o : tests/clibrary/lib1.c $(OBJ)/tests/clibrary/+clibrary2_hdrs/library2.h
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary2/tests/clibrary/lib2.cc.mark $(OBJ)/tests/clibrary/+clibrary2/tests/clibrary/lib2.cc/lib2.o : tests/clibrary/lib2.cc $(OBJ)/tests/clibrary/+clibrary2_hdrs/library2.h
...
$(OBJ)/.sentinels/tests/clibrary/+clibrary2.mark $(OBJ)/tests/clibrary/+clibrary2/+clibrary2.a : $(OBJ)/tests/clibrary/+clibrary2/tests/clibrary/lib1.c/lib1.o $(OBJ)/tests/clibrary/+clibrary2/tests/clibrary/lib2.cc/lib2.o
