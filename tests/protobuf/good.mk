...
$(OBJ)/.sentinels/tests/protobuf/+protolib.mark : tests/protobuf/test.proto
...
$(OBJ)/.sentinels/tests/protobuf/+protolib2.mark : tests/protobuf/test2.proto $(OBJ)/tests/protobuf/+protolib/tests/protobuf/+protolib.descriptor
...
$(OBJ)/tests/protobuf/+protolib_c_srcs/tests/protobuf/test2.pb.cc $(OBJ)/tests/protobuf/+protolib_c_srcs/tests/protobuf/test2.pb.h $(OBJ)/tests/protobuf/+protolib_c_srcs/tests/protobuf/test.pb.cc $(OBJ)/tests/protobuf/+protolib_c_srcs/tests/protobuf/test.pb.h : $(OBJ)/.sentinels/tests/protobuf/+protolib_c_srcs.mark
$(OBJ)/.sentinels/tests/protobuf/+protolib_c_srcs.mark : tests/protobuf/test2.proto tests/protobuf/test.proto
...
$(OBJ)/tests/protobuf/+protolib_c_hdrs/tests/protobuf/test2.pb.h $(OBJ)/tests/protobuf/+protolib_c_hdrs/tests/protobuf/test.pb.h : $(OBJ)/.sentinels/tests/protobuf/+protolib_c_hdrs.mark
$(OBJ)/.sentinels/tests/protobuf/+protolib_c_hdrs.mark : $(OBJ)/tests/protobuf/+protolib_c_srcs/tests/protobuf/test2.pb.h $(OBJ)/tests/protobuf/+protolib_c_srcs/tests/protobuf/test.pb.h
...
$(OBJ)/.sentinels/tests/protobuf/+protolib_c.mark : $(OBJ)/tests/protobuf/+protolib_c/tests/protobuf/+protolib_c_srcs/tests/protobuf/test2.pb.cc/test2.pb.o $(OBJ)/tests/protobuf/+protolib_c/tests/protobuf/+protolib_c_srcs/tests/protobuf/test.pb.cc/test.pb.o
