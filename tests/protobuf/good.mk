...
tests/protobuf/+protolib $(OBJ)/.sentinels/tests/protobuf/+protolib.mark $(OBJ)/tests/protobuf/+protolib/tests/protobuf/+protolib.descriptor &: tests/protobuf/test.proto
...
tests/protobuf/+protolib2 $(OBJ)/.sentinels/tests/protobuf/+protolib2.mark $(OBJ)/tests/protobuf/+protolib2/tests/protobuf/+protolib2.descriptor &: tests/protobuf/test2.proto $(OBJ)/tests/protobuf/+protolib/tests/protobuf/+protolib.descriptor
...
tests/protobuf/+protolib_c $(OBJ)/.sentinels/tests/protobuf/+protolib_c.mark $(OBJ)/tests/protobuf/+protolib_c/+protolib_c.a &: $(OBJ)/tests/protobuf/+protolib_c/tests/protobuf/+protolib_c_srcs/tests/protobuf/test2.pb.cc/test2.pb.o $(OBJ)/tests/protobuf/+protolib_c/tests/protobuf/+protolib_c_srcs/tests/protobuf/test.pb.cc/test.pb.o
...
tests/protobuf/+all $(OBJ)/.sentinels/tests/protobuf/+all.mark &: $(OBJ)/tests/protobuf/+protolib2/tests/protobuf/+protolib2.descriptor $(OBJ)/tests/protobuf/+protolib_c/+protolib_c.a $(OBJ)/tests/protobuf/+protolib_c_hdrs/tests/protobuf/test2.pb.h $(OBJ)/tests/protobuf/+protolib_c_hdrs/tests/protobuf/test.pb.h
	$(hide) mkdir -p $(OBJ)/.sentinels/tests/protobuf
	$(hide) touch $@
AB_LOADED = 1
